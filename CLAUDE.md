...
- Auth email: custom SMTP via Gmail (app password entered in the Supabase dashboard only), "Confirm email" on, Site URL = the Vercel domain. Minimum password length 8 in Supabase to match the form.
